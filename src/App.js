  ...
  function getURL(company) {
    ...
    switch (company) {
      case "Jpmc":
        ...
        break;
      case 'Hpcl':
        url = 'https://bsmedia.business-standard.com/media-handler.php?mediaPath=http://bsmedia.business-standard.com/_media/bs/img/article/2013-09/22/full/1379849324-2914.jpg&width=1200';
        break;
      case "Box 8":
